...
df.to_csv('../../../Gráficas finales/History 50,100/historyconvtrayec.csv', index=False)
...
new_model = keras.models.load_model('../../../Modelos/Modelos 50,100/convolucionaltr.h5', custom_objects=custom_objects)

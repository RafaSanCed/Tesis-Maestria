...
path = 'D:\Documentos de trabajo\Maestría\Tesis Maestría\Trabajo Python Tesis\Github Tesis\Base de datos\Campo 20 puntos'
...
df.to_csv('../../Gráficas finales/historycampvec20.csv', index=False)
